...
<div class="slider_content">
  <div class="container-fluid">
    <div class="row">
      <div class="category_col col-md-2">
        <h5 class="title_bg"><i class="fas fa-bars ml-1 pr-2"></i> Categories</h5>
        <ul class="menu">
          ...
          <li> <a href="#"><i class="fas fa-car  mr-2"></i>Cars & Bikes</a>
          ...
          <li> <a href="#"><i class="fas fa-mobile-alt  mr-2"></i>Mobile & Tablets</a>
          ...
          <li> <a href="#"><i class="fas fa-laptop mr-2"></i>Electronics/Appliances</a>
          ...
          <li> <a href="#"><i class="fas fa-couch  mr-2"></i>Home & Furnishing</a>
          ...
          <li> <a href="#"><i class="fas fa-toolbox  mr-2"></i>Services</a>
      ...
      <div class="col-md-8">
        <div id="owl-demo" class="owl-carousel owl-theme">
          <div class="item"><img src="img/slides/login.png" alt=""></div>
          <div class="item"><img src="img/slides/login.png" alt=""></div>
          <div class="item"><img src="img/slides/login.png" alt=""></div>
        </div>
      </div>
...
<div class="ad container-fluid mt-3">
...
<!-- <div class="container-fluid mt-4">
  <div class="row">
    <div class="col-md-4 mt-2">
      <img src="img/featured1.png" alt="" width="100%">
    </div>
    <div class="col-md-4 mt-2">
      <img src="img/featured1.png" alt="" width="100%">
    </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2 help">
        <h5 class="title_bg"><i class="fas fa-hands-helping ml-2 pr-2"></i>Help</h5>
        <ul class="lst border_ul">
          <li><a href=""><i class="fas fa-angle-right"></i> Buying products?</a></li>
          <li><a href=""><i class="fas fa-angle-right"></i> Selling products?</a></li>
          <li><a href=""><i class="fas fa-angle-right"></i> Ad posting rules</a></li>
          <li><a href=""><i class="fas fa-angle-right"></i> Safety tricks</a></li>
          <li><a href=""><i class="fas fa-angle-right"></i> FAQ</a></li>
        </ul>

        <div class="ad p-z">
          <img src="img/ads/ad3.gif" alt="" width="100%">
        </div>
...
<div class="ad container-fluid mt-3">
  <img src="img/ads/ad6.gif" alt="" width="100%">
</div>
...
<section class="product_info mt-5">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2">
        <h5 class="title_bg"><i class="fas fa-shopping-bag ml-2 pr-2"></i> Shop By</h5>
        <ul class="lst">
          <li><a href="#"><img src="img/side_banner/1.jpg" alt="" width="100%"></a></li>
          <li class="mt-2"><a href="#"><img src="img/side_banner/2.jpg" alt="" width="100%"></a></li>
          <li class="mt-2"><a href="#"><img src="img/side_banner/3.jpg" alt="" width="100%"></a></li>
          <li class="mt-2"><a href="#"><img src="img/side_banner/2.jpg" alt="" width="100%"></a></li>
          <li class="mt-2"><a href="#"><img src="img/side_banner/1.jpg" alt="" width="100%"></a></li>
        </ul>
      </div>
      <div class="col-md-10">
...
<!-- RECENT -->
<section class="product_info recent mt-5">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2 mt-5">
        <a href="#"><img src="img/call_us.jpg" alt="" width="100%"></a>
        <ul class="lst border_ul">
          <li><a href="#"><img src="img/icons/shipped.png" alt="" width="20%" class="icon pr-2"> Free Delivery</a></li>
          <li><a href="#"><img src="img/icons/security.png" alt="" width="20%" class="icon pr-2"> Order Protection</a></li>
          <li><a href="#"><img src="img/icons/gift.png" alt="" width="20%" class="icon pr-2"> Promotion Gift</a></li>
          <li><a href="#"><img src="img/icons/recycle.png" alt="" width="20%" class="icon pr-2"> Money Back</a></li>
        </ul>

        <div class="ad">
          <img src="img/ads/ad2.jpeg" alt="" width="100%">
        </div>
      </div>
...
<section class="newsletter mt-5">
  <div class="container">
    <div class="row">
      <div class="col-md-4 mt-2">
        <h3><i class="far fa-paper-plane"></i> Sign up to Newsletter</h3>
      </div>
      <div class="col-md-4">
        <p class="mt-3">...and subscribe to get daily updates</p>
      </div>
      <div class="col-md-4 mt-1">
        <div class="input-group">
          <input type="email" class="form-control" placeholder="Enter your email address" aria-label="Recipient's email" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <button type="button" name="button" class="btn btn-regular subscribe_btn rounded-0">SUBSCRIBE</button>
          </div>
        </div>
      </div>
    </div>
